...
@section('content')
        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 mb-xl-0 mb-4">
                    <h3 class="font-weight-bold">Konversi MBKM</h3>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Import Konversi MBKM</h4>
                    <div class="card-description">
                        <p>Petunjuk :</p>
                        <ol class="list">
                            <li>Download file template excel <a
                                    href="{{ url('files/import-kampus-merdeka.xlsx') }}">disini</a></li>
                            <li>Isikan data bimbingan mahasiswa menggunakan file excel sesuai petunjuk</li>
                        </ol>
                    </div>
                    <form action="{{ url('dashboard/kampus-merdeka') }}" method="post" enctype="multipart/form-data"
                        id="formImport">
                        @csrf
                        <div class="row">
