...
@section('content')
        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 mb-xl-0 mb-4">
                    <h3 class="font-weight-bold">Pengujian Mahasiswa</h3>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Import Pengujian Mahasiswa</h4>
                    <div class="card-description">
                        <p>Petunjuk :</p>
                        <ol class="list">
                            <li>Download file template excel <a
                                    href="{{ url('files/import-pengujian-mahasiswa.xlsx') }}">disini</a></li>
                            <li>Isikan data pengujian mahasiswa menggunakan file excel sesuai petunjuk</li>
                        </ol>
                    </div>
                    <form action="{{ url('dashboard/pengujian-mahasiswa') }}" method="post" enctype="multipart/form-data"
                        id="formImport">
                        @csrf
                        <div class="row">
