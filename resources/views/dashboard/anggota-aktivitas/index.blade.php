...
@section('title', 'Anggota Aktivitas Mahasiswa')
...
@section('content')
        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 mb-xl-0 mb-4">
                    <h3 class="font-weight-bold">Anggota Aktivitas Mahasiswa</h3>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Import Anggota Aktivitas Mahasiswa</h4>
                    <div class="card-description">
                        <p>Petunjuk :</p>
                        <ol class="list">
                            <li>Download file template excel <a
                                    href="{{ url('files/import-anggota-aktivitas-mahasiswa.xlsx') }}">disini</a></li>
                            <li>Isikan data anggota aktivitas mahasiswa menggunakan file excel sesuai petunjuk</li>
                        </ol>
                    </div>
                    <form action="{{ url('dashboard/anggota-aktivitas') }}" method="post" enctype="multipart/form-data"
                        id="formImport">
                        @csrf
                        <div class="row">
