...
@section('title', 'Referensi Pengujian')
    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">Referensi Pengujian</h3>
            </div>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-5">Data Referensi Pengujian</h4>
                <div class="row">
                ...
                <div class="table-responsive">
                    <table id="refUjian" class="display expandable-table table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>ID Aktivitas</th>
